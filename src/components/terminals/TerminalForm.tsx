...
import { useAddTerminal, useUpdateTerminal } from "../../hooks/useTerminals";
...
const TerminalForm = ({
  ...
  const { mutateAsync: addMutation, isPending: adding } = useAddTerminal();
  ...
  return (
    ...
    >
      <div className="rounded-tr-[4px] rounded-tl-[4px] p-3 bg-[#EBEFF1] flex items-center justify-between">
        <h2>{initialData ? "Edit Branch" : "Add Branch"}</h2>
        <button
          onClick={handleClose}
